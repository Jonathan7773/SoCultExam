...
file_path = raw"C:\Users\jonat\Desktop\University\Exam\4_Semester\SocCult\ImportantData\DataFiles\resultsP2.jld2" 
...
#savefig(CombinedAlgoPlot, "TotalRewardPlotsP2.svg")

CombinedPaperPlot = plot(TotalPlot, TFTPlot, PavPlot, GrofPlot)
#savefig(CombinedPaperPlot, "PaperPlotsP2.svg")

#################### Table truncated ####################

grouped_df = combine(groupby(results_df, [:lr_pB, :beta]), :score_AIF_agent => sum)

sort_df = sort(grouped_df, :score_AIF_agent_sum, rev = true)
